...
- [ ] Deployed WASM traceable to its source — SEP-55 build metadata plus a GitHub attestation, deployed from the release artifact ([SKILL.md](SKILL.md#verify-your-build))
